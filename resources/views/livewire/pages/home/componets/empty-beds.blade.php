                        ...
                        @forelse($this->beds->getBeds() as $all_beds)
                            ...
                            @if ($all_beds->state == 'active')
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-primary"
                                            wire:click="openModal({{ json_encode($all_beds['bed']) }})">
                                            <i class="fas fa-plus"></i> افزودن
                                        </button>
                                    </td>
                                </tr>
        ...
        <div class="modal-dialog modal-dialog-center">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="saveaddresident">
                        <span wire:loading.remove wire:target="saveaddresident">ذخیره</span>
                        <span wire:loading wire:target="saveaddresident">
        ...
        document.addEventListener('livewire:init', function() {
            ...
            Livewire.on('show-modal', function() {
                ...
                setTimeout(() => {
                    ...
                    modalElement.addEventListener('shown.bs.modal', function() {
                        const firstInput = modalElement.querySelector('#addresidentName');
                        if (firstInput) {
                            firstInput.focus();
                        }
                    }, {
